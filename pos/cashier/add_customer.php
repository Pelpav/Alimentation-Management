              ...
              <form method="POST">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="hidden" name="identifiant_client" value="<?php echo $cus_id; ?>" class="form-control">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addCustomer" value="Add Client" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
