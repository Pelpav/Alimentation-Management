...
if (isset($_POST['updateCustomer'])) {
  ...
  if (empty($_POST["numero_client"]) || empty($_POST["nom_client"]) || empty($_POST['email_client']) || empty($_POST['motdepasse_client'])) {
    ...
    //bind paramaters
    $rc = $postStmt->bind_param('sssss', $nom_client, $numero_client, $email_client, $motdepasse_client, $update);
    $postStmt->execute();
...
<body>
  ...
  <div class="main-content">
    ...
    $update = $_GET['update'];
    $ret = "SELECT * FROM  clients WHERE identifiant_client = '$update' ";
                        ...
                        <form method="POST">
                          <div class="form-row">
                            <div class="col-md-6">
                              ...
                              <input type="text" name="nom_client" value="<?php echo $cust->nom_client; ?>" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Client Numéro</label>
                              <input type="text" name="numero_client" value="<?php echo $cust->numero_client; ?>"
                          ...
                          <div class="form-row">
                            <div class="col-md-6">
                              ...
                              <input type="email" name="email_client" value="<?php echo $cust->email_client; ?>"
                                class="form-control" value="">
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="form-row">
                            <div class="col-md-6">
                              <input type="submit" name="updateCustomer" value="Update Client" class="btn btn-success" value="">
                            </div>
                          </div>
                        </form>
                      </div>
