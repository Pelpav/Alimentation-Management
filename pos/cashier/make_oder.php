                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="nom_client" id="custNom"
                                            onChange="getCustomer(this.value)">
                                            <option value="">Select Client Nom</option>
                                            <?php
                                            //Load All Clients
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="identifiant_client" readonly id="customerID"
                                            class="form-control">
                                    </div>

                                    <div class="col-md-4">
                                        <label>Code De Paiement</label>
                                        <input type="text" name="code_commande"
