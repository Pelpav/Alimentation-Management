...
if (isset($_POST['pay'])) {
    ...
    if (empty($_POST["code_paiements"]) || empty($_POST["montant_paiements"]) || empty($_POST['methode_paiements'])) {
        ...
        if (!isset($_GET['identifiant_commande']) || !isset($_GET['identifiant_client']) || !isset($_GET['statut_commande'])) {
            ...
            // echo "code_paiements: $code_paiements<br>";
            // echo "identifiant_commande: $identifiant_commande<br>";
            // echo "identifiant_client: $identifiant_client<br>";
            // echo "montant_paiements: $montant_paiements<br>";
            // echo "methode_paiements: $methode_paiements<br>";
            // echo "pay_id: $pay_id<br>";
            // echo "statut_commande: $statut_commande<br>";
            // echo "cree_le: $cree_le<br>";
