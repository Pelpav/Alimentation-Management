...
<body>
    ...
    <?php echo $prod->stock_produit; ?>
                                            ...
                                            <td>
                                                <a href="products.php?delete=<?php echo $prod->identifiant_produit; ?>">
                                                ...
                                                <a
                                                    href="update_product.php?update=<?php echo $prod->identifiant_produit; ?>">
                                                    <button class="btn btn-sm btn-primary">
                                                        <i class="fas fa-edit"></i>
                                                        Modifier
                                                    </button>
                                                </a>
                                                <a href="#" class="btn btn-sm btn-primary add-stock"
                                                    data-id="<?php echo $prod->identifiant_produit; ?>">
                                                    <i class="fas fa-edit"></i>
                                                    Ajouter du stock
                                                </a>
