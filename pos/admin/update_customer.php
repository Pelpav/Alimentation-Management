                                        ...
                                        <div class="card shadow">
                                            ...
                                            <div class="card-body">
                                                <form method="POST">
                                                    <div class="form-row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="nom_client"
                                                                value="<?php echo $cust->nom_client; ?>" class="form-control">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label>Client Numéro</label>
                                                            <input type="text" name="numero_client"
                                                                value="<?php echo $cust->numero_client; ?>" class="form-control"
                                                                value="">
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="form-row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="email" name="email_client"
                                                                value="<?php echo $cust->email_client; ?>" class="form-control" value="">
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-6">
                                                            <input type="submit" name="updateCustomer" value="Modifier Client"
